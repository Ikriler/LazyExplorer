export class ElementContructor {
  static createCard(success, imgSrc, logFrom, reason, progressValue, itemIndex) {
    ...
    card += '<button id=\"deleteSimulationButton' + itemIndex + '\" type="button" class="btn btn-danger" style="margin-left: 15px;">Delete</button>';
